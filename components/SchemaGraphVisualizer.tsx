...
const NODES: Record<NodeId, GraphNode> = {
  ...
  rating: {
    ...
    descEn: 'Use only when real reviews are displayed on the page. Invented ratings violate Google spam policies.',
    descAr: 'استخدم AggregateRating فقط إذا كانت التقييمات ظاهرة فعليًا في الصفحة.',
    googleRoleEn: 'May support review rich results when reviews are visible on-page',
    googleRoleAr: 'قد يدعم نتائج المراجعة عندما تكون التقييمات ظاهرة في الصفحة',
    snippet: `{\n  "@type": "AggregateRating",\n  "ratingValue": "<only if reviews are on-page>",\n  "reviewCount": "<only if reviews are on-page>",\n  "bestRating": "5"\n}`,
  },
  faq: {
    id: 'faq',
    ...
    descEn: 'Exposes question-answer pairs for retrieval crawlers. Google no longer shows FAQ rich results.',
    descAr: 'يعرّض أزواج سؤال/جواب لزواحف الاسترجاع. جوجل لم يعد يعرض نتائج FAQ الغنية.',
