...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    blockers: {
      ...
      title: 'Detected visibility findings',
      subtitle: 'Highest-severity findings from this scan, each with raw evidence from the fetched page.',
    ...
    lockedSection: {
      ...
      title: 'Copy-paste fixes and the full evidence report',
      subtitle: 'Unlock the remaining findings (if any), platform-specific fix code, and a shareable report. The free scan already showed every check that ran.',
      ctaUnlockAll: 'Fix My Website — $9 (One-Time)',
      ctaSubtext: 'Fixes for WordPress, Next.js, and Shopify. 30-day money-back guarantee. Valid markup does not guarantee a Google rich result.',
      feature1: 'Every finding from this scan, with evidence — not a fabricated issue count',
    ...
    modal: {
      ...
      subtitle: 'Get production-ready code fixes for WordPress, Next.js, and Shopify for the findings from this scan.',
    ...
    aiPreview: {
      ...
      subtitle: 'Simulation of search/AI presentation from this fetch. Not a live Google or ChatGPT result.',
      tabBefore: 'Current fetch',
      tabAfter: 'Sample richer presentation',
    ...
    trafficLoss: {
      ...
      subtitle: 'Qualitative readout from this audit’s score. Not a traffic or revenue forecast.',
      lostRate: 'Readiness band',
      estLostVisitors: 'What this score means',
      recoveryTime: 'Next step',
      actionNote: 'Copy the recommended code fixes, then request indexing in Search Console.',
    },
    pdfExport: {
    ...
    knowledge: {
      ...
      subtitle: 'Based on Google Search documentation, OpenAI crawler guidelines, and the current Schema.org vocabulary.',
  ...
  ar: {
    ...
    blockers: {
      ...
      title: 'العوائق المكتشفة في هذا الفحص',
      subtitle: 'نتائج هذا الفحص حسب الخطورة، وكل واحدة عليها دليل خام من الصفحة المجلوبة.',
    ...
    lockedSection: {
      ...
      title: 'أكواد الإصلاح والتقرير الكامل بالأدلة',
      subtitle: 'افتح بقية النتائج إن وُجدت، وأكواد الإصلاح حسب المنصة، وتقرير قابل للمشاركة. الفحص المجاني أظهر كل فحص تم تشغيله.',
      ctaUnlockAll: 'أصلح موقعي الآن — $9 (دفعة واحدة)',
      ctaSubtext: 'إصلاحات لووردبريس وNext.js وشوبيفاي. ضمان استرجاع 30 يوماً. الوسم الصحيح لا يضمن نتيجة غنية من جوجل.',
      feature1: 'كل نتائج هذا الفحص مع الأدلة — بدون عدد مشاكل مختلق',
    ...
    modal: {
      ...
      subtitle: 'احصل على أكواد جاهزة للإنتاج لـ WordPress و Next.js و Shopify لنتائج هذا الفحص.',
    ...
    aiPreview: {
      ...
      subtitle: 'محاكاة لعرض البحث/الذكاء الاصطناعي من هذا الجلب. ليست نتيجة حية من جوجل أو ChatGPT.',
      tabBefore: 'هذا الجلب',
      tabAfter: 'معاينة أغنى (عينة)',
    ...
    trafficLoss: {
      ...
      title: 'مخاطر ظهور البحث بالذكاء الاصطناعي',
      subtitle: 'قراءة نوعية من درجة هذا الفحص. ليست توقّع زيارات أو إيرادات.',
      lostRate: 'نطاق الجاهزية',
      estLostVisitors: 'ماذا تعني هذه الدرجة',
      recoveryTime: 'الخطوة التالية',
      actionNote: 'انسخ أكواد الإصلاح المقترحة ثم اطلب الفهرسة من Search Console.',
    },
    pdfExport: {
    ...
    knowledge: {
      ...
      subtitle: 'مبني وفق توثيق بحث جوجل وإرشادات زواحف OpenAI ومفردات Schema.org الحالية.',
